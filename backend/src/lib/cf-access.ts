...
// hostname). Falls back to the known team domain provisioned in #34.
...
export const TEAM_DOMAIN = process.env.CF_ACCESS_TEAM_DOMAIN || 'alejoframes.cloudflareaccess.com';
